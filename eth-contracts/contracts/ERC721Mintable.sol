...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner!=address(0), "Address is not in the correct type or format");
        _owner = newOwner;
...
contract Pausable is Ownable {
    ...
    modifier paused(){
      require(_paused == true,"Contract isnot paused.");
        _;
    }

    function setPausedState(bool state) public onlyOwner(){
      require(state!=_paused, "Paused already set to this state.");
      _paused = state;
      if(state){
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to!=_tokenOwner[tokenId], "The owner of the tokenId is the same as the to address");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId),"Owner for this tokenId already exists!");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(_tokenOwner[tokenId]==from, "from address isnot the owner of the provided tokenId");
        // TODO: require token is being transfered to valid address
        require(to != address(0), "from address isnot valid");
        // TODO: clear approval
...
contract CustomERC721Token is ERC721Metadata {
    ...
    constructor () public ERC721Metadata("bleedingEdgeTok","bETok","https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
